...
#         path = os.path.join(BASE_DIR, 'resources/ngrams/vocab_cs.wngram')
...
#         path = os.path.join(BASE_DIR, 'resources/ngrams/2gm-0005.wngram')
#         self.bigrams = self.clasificadorobj.loadDic(path)
#         self.totalBis = sum(self.bigrams.values())
        
#         path = os.path.join(BASE_DIR, 'resources/ngrams/3gm-0006.wngram')
#         self.trigrams = self.clasificadorobj.loadDic(path)
#         self.totalTris = sum(self.trigrams.values())

#         # DICCIONARIOE2R
#         path = os.path.join(BASE_DIR, 'resources/stop_words/unigram2_non_stop_words.csv')
...
#         # PPDB
#         path = os.path.join(BASE_DIR, 'resources/dicuniwords.csv')
